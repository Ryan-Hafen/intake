...
class ReferralForm(FlaskForm):
    ...
    phone = StringField('Phone', validators=[Length(min=0, max=10)], render_kw={"placeholder": "3334445555","pattern": "[0-9]{10}"})
    email = StringField('Email', render_kw={"placeholder": "example@email.com"})
    dob = DateField('Date of Birth')
    poa_address1 = StringField('Patient Address')
    ...
    discharge_date = DateField('Hospital/SNF/Home Health Discharge Date', validators=[Optional()])
    ...
    disc_pt = BooleanField('PT Physical Therapy', default=True)
    ...
    med_phone = StringField('Phone', validators=[DataRequired(), Length(min=10, max=10)], render_kw={"placeholder": "3334445555","pattern": "[0-9]{10}"})
