...
class Referral(db.Model):
    ...
    med_type_phy = db.Column(db.Boolean, nullable=True, default=False)
    med_type_np = db.Column(db.Boolean, nullable=True, default=False)
    med_type_pa = db.Column(db.Boolean, nullable=True, default=False)
